...
import FeedRightContent from './FeedRightContent';
...
function ProfileBody({
  ...
  return (
    <div className={`grow flex flex-row md:translate-x-0 transform transition-transform duration-300 ease-in-out ${profileSidebarOpen ? 'translate-x-1/3' : 'translate-x-0'}`} style={{ justifyContent: 'space-between', width: '100%', backgroundColor: 'floralwhite' }}>
      <div style={{ width: '70%' }}>
        <div style={{ width: '100%', backgroundColor: '#ffff', borderRadius: "5%" }} className='mx-2 mt-2 my-2'>

          {/* Profile background */}
          <div className="relative h-56 bg-slate-200 mt-">
        ...
        {/* Profile content */}
        <div className="flex flex-col xl:flex-row xl:space-x-16 m-2 p-6"
          style={{ width: '100%', backgroundColor: '#ffff', borderRadius: '5%' }}
        >
